...
Welcome to my Github page! &emsp;
[![counter](https://en2yvmcy89kmzwi.m.pipedream.net)]<br />
<!-- <img align="right" alt="img" src="https://github.com/dnb02/dnb02/blob/main/cover_image.jpg" width="50%" height="auto" /> -->

#### 🌱 Experience:
- Writing API Backends for genai applications

#### 🌱 Things I am currently working on: 
- Understanding the Linux kernel network stack and the kernel tracing infrastructure
